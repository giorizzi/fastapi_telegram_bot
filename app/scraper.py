...
def get_availability(query: str, start_date: date, end_date: date):
    ...
    try:
        ...
        element = driver.find_element(By.XPATH, "//button[text()='Camping & Lodging']")
        element.click()

        search_input = driver.find_element(By.XPATH, "//input[@id='hero-camping-search-input']")
        ...
        search_button = driver.find_element(By.XPATH, "//button[@id='gtm-camping-lodging-hero-search']")
        search_button.click()
